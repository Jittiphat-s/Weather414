<template>
    <div class="weatherapp relative bg-gray-500 text-white h-screen" >
      ...
      <div  class="absolute bottom-5 inset-x-0  flex justify-center" >
        <p class="text-center " > Jittiphat Sanom 6504101414 </p>
        <div class="ml-3 mt-1" >  <a href="https://github.com/" class="mr-2" > <ion-icon name="logo-github"></ion-icon> </a>  <a href="https://twitter.com/"><ion-icon name="logo-twitter"></ion-icon></a> </div>
      </div>
     </div>
...
export default {
  ...
  data(){
     return{
       ...
       api_key: "7ec1ce83beb6e7565925e566ce3ba48a",
